...
__direction_to_vector1d_cache = {North: 1, South: -1, East: 1, West: -1}

__vector1d_y_to_direction_cache = {1: North, -1: South, 0: None}

__vector1d_x_to_direction_cache = {1: East, -1: West, 0: None}

__direction_negate_cache = {North: South, South: North, East: West, West: East}

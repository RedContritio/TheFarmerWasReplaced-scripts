...
def rect_allocator_compact(allocator):
	...
	if allocated_count > 1:
		allocated_items = list_sort_by_yx(allocated_items,
										 __allocator_get_item_y,
										 __allocator_get_item_x)
	...
	while i < len(allocated_items):
		...
		new_y, new_x = __allocator_find_compact_position(allocator, y, x, h, w, occupied)
...
def rect_allocator_instance_initialize(world_size):
	...
	return singleton_initialize(__SINGLETON_KEY_RECT_ALLOCATOR, rect_allocator(world_size, world_size))

    ...
    def find_spec(self, fullname, path, target=None):
        ...
        if spec.origin:
            ...
            if module_path.parent == _PROJECT_DIR:
                print(f"[DEBUG TICK TRANSFORMER] Transforming module: {fullname} at {spec.origin}")
                spec.loader = TickInjectionLoader(spec.loader)
            else:
                print(f"[DEBUG TICK TRANSFORMER] Skipping module: {fullname} at {spec.origin} (not in project root)")

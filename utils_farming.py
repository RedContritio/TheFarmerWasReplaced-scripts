...
def farming_overwrite_here(
    target_entity, protect_entity=None, wait_if_protect=False, do_harvest=None
):
...
def farming_create_overwrite_hook(
    target_entity, protect_entity=None, wait_if_protect=False, do_harvest=None
):
    ...
    def __hook(point, arg):
        farming_overwrite_here(
            target_entity, protect_entity, wait_if_protect, do_harvest
        )
